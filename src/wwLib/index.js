...
export default {
    ...
    globalContext: reactive({
        ...
        colors: computed(() => {
            ...
            return theme === 'dark' ? {"eaed7c02-9ef5-40de-9052-21364c34a98d":"#E08A42","807027a7-4259-4150-95c6-f81a722c2428":"#F4E7C9"} : {"eaed7c02-9ef5-40de-9052-21364c34a98d":"#E08A42","807027a7-4259-4150-95c6-f81a722c2428":"#F4E7C9"};
            /* wwFront:end */
        }),
        spacings:
         /* wwFront:start */
